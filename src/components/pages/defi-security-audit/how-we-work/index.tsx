    ...
    <section id="howWeWork" className="bg-pink">
      <div className="border-dark-gray 5xl:border-x mx-auto w-full max-w-[1920px]">
        ...
        <div className="border-dark-gray border-b">
          <header className="border-dark-gray flex h-[100px] items-center px-5 2xl:h-[150px] 2xl:px-[60px]">
        ...
        <div className="border-dark-gray flex flex-1 flex-row border-b 2xl:px-[60px]">
          ...
          <TextWithDot className="border-dark-gray max-h-full flex-1 !p-5 max-lg:hidden lg:border-r 2xl:!px-[40px] 2xl:!py-[60px] [&>div]:!text-[20px] [&>div]:!leading-[140%]">
            {HOW_WE_WORK_DATA[selectedIndex]?.description}
          </TextWithDot>

          <LogoOnABlock variant="pc" className="max-lg:hidden lg:border-r" />
        </div>
