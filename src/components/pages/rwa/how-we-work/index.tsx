  ...
  return (
    <section id="howWeWork" className="bg-pink">
      <div className="border-dark-gray 5xl:border-x mx-auto w-full max-w-[1920px]">
        ...
        <div className="border-dark-gray flex flex-1 flex-row 2xl:px-[60px]">
              ...
              >
                {HOW_WE_WORK_DATA.map((item, index) => (
                  <Fragment key={index}>
                    ...
                    >
                      <h3 className="flex items-center gap-5 text-left font-mono text-[20px] uppercase text-black 2xl:text-2xl">
          ...
          <TextWithDot className="border-dark-gray order-1 max-h-full flex-1 !p-5 max-lg:hidden lg:border-r 2xl:!px-[40px] 2xl:!py-[60px] [&>div]:!text-[20px] [&>div]:!leading-[140%]">
            {HOW_WE_WORK_DATA[selectedIndex]?.description}
          </TextWithDot>

          <div className="border-dark-gray order-2 flex-1 max-lg:hidden lg:border-r [&>div]:!flex [&>div]:h-full">
            <LogoOnABlock />
          </div>
        </div>
