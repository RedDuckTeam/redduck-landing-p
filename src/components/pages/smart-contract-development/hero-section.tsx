...
const BREADCRUMB_ITEMS = [
  { label: 'Home', href: '/' },
  { label: 'Services' },
  { label: 'Smart Contract Development_' },
];
...
export function HeroSection() {
  return (
    <CustomSection className="bg-black text-white *:flex *:flex-col *:!py-0">
      ...
      <div className="border-concrete grid grid-cols-1 border-y lg:grid-cols-3">
        <div className="border-concrete col-span-2 flex flex-col border-b lg:border-b-0 lg:border-r">
          ...
          <div className="flex flex-col gap-[30px] px-5 py-10 2xl:gap-[40px] 2xl:p-[60px]">
            <TextWithDot className="!p-0 [&>div]:!text-base [&>div]:!leading-[140%] [&>div]:!text-white lg:[&>div]:!text-xl [&>svg]:fill-white">
              Write once, secure forever, audit-ready from day one
            </TextWithDot>
            <a
              href="#getInTouch"
              className={cn(
        ...
        <div className="flex items-center justify-center p-5 md:p-10 2xl:p-[60px]">
          <img
            src="/images/smart-contract/hero.webp"
            alt="Smart Contract Development illustration"
