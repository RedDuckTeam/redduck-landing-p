...
import type { CookieConsentProps } from './CookieConsent.props';
import { defaultCookieConsentProps } from './CookieConsent.props';
import type { CookieConsentState } from './CookieConsent.state';
import { defaultState } from './CookieConsent.state';
...
> {
  ...
  setCookie(cookieName: string, cookieValue: string | object) {
    ...
    Cookies.set(cookieName, String(cookieValue), cookieOptions);
  }
   ...
   */
  handleScroll = () => {
    const { acceptOnScrollPercentage } = {
      ...defaultCookieConsentProps,
      ...this.props,
    };
  ...
  render() {
    ...
    if (disableStyles) {
      ...
      myOverlayStyle = Object.assign(
        {},
        { ...this.state.overlayStyle, ...overlayStyle },
      );
